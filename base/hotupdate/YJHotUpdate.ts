...
import { JSB, ccclass, menu, Component, Node, game, AssetsManager, Manifest } from '../../yj';
import { no } from '../../no';
...
export class YJHotUpdate extends Component {
    ...
    public updateFiles(): void {
        if (this._am) {
            ...
            downloader.createDownloadTask(remoteManifest.getVersionFileUrl(), this._storagePath + '/' + 'version.manifest');
            this._am.update();
        }
    }
