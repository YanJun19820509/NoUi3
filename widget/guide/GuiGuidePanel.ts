...
import { YJGuideTypeInfo } from './YJGuidePanel';
 ...
 * Author = mqsy_yj
 * FileBasename = GuiGuidePanel.ts
 * FileBasenameNoExtension = GuiGuidePanel
 * URL = db://assets/common/widget/guide/GuiGuidePanel.ts
 * ManualUrl = https://docs.cocos.com/creator/3.4/manual/zh/
 *
 */

@ccclass('GuiGuidePanel')
@panelPrefabPath('db://assets/HackUi/widget/guide/guidePanel.prefab')
/**
 * 新手引导面板基类
 * @example
 * // 编辑器配置示例：
 ...
 * GuiGuidePanel.next();
 * // 检查是否正在引导中
 * if (GuiGuidePanel.isGuiding) return;
 */
export class GuiGuidePanel extends GuiPanel {
    ...
    /** 单例实例 */
    private static _ins: GuiGuidePanel;
    ...
    onLoad() {
        super.onLoad();
        GuiGuidePanel._ins = this;
    }

    onDestroy() {
        GuiGuidePanel._ins = null;
    }
    ...
    protected onInitPanel() {
        this.curStep = this.curStep || this.dataWork.data.curStep;
     ...
     * @example
     * // 当游戏暂停时强制隐藏所有引导：
     * GuiGuidePanel._ins?.hideAllGuideNodes();
     */
