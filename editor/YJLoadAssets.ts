...
import { no } from '../no';
import { SpriteFrameDataType, TextureInfo } from '../types';
...
export class YJLoadAssets extends Component {
    ...
    //         const material = ssm.getMaterial(this.textures);
    //         this.setMaterialToDynamicAtlas(material);
    //     }
    // }
    ...
    public getSpriteFrameInAtlas(name: string): [number, SpriteFrameDataType] {
        return this.materialInfo.getSpriteFrameInAtlas(name);
    }
    // public getSpriteFrameInAtlas(name: string): [number, SpriteFrameDataType] {
