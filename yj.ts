...
export const UIRenderer = _cc.UIRenderable;
export type UIRenderer = _cc.UIRenderable;
...
export const AssetsManager = _cc.AssetManager;
export type AssetsManager = _cc.AssetManager;
...
export type WrapMode = _cc.__private._cocos_core_animation_animation_clip__WrapMode_;
